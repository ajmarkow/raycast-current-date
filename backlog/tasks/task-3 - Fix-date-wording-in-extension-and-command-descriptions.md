...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Extension description at package.json:5 acknowledges both date and time
- [ ] #2 Command description at package.json:16 does not restate the extension description verbatim; it focuses on the clipboard-copy behavior
- [ ] #3 Command description length is reasonable for a Raycast tooltip (not multi-sentence)
<!-- AC:END -->
