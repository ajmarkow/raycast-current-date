...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 package.json:1720 UTC Offset preference description states whole-hour offsets only and points users to IANA mode for :30/:45 zones
- [ ] #2 No code changes to parseUtcOffsetHours required (scope stays whole hours)
<!-- AC:END -->
